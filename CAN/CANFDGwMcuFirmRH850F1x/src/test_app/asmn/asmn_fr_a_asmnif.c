...
#define ASMN_MENULINE_HDR1  "FLEXRAY APPLICATION MENU\n"
#define ASMN_MENULINE_HDR2  "  (C) RL 01/2017    \n\n"
#define ASMN_MENULINE_MEN0  " 0 -> Exit\n"

#if( FR_TYPE == FR_FLXA_0012 )
#ifdef Application_1
#define ASMN_MENULINE_MEN1  " 1 -> Start Application 1\n"
#endif
#ifdef Application_2
#define ASMN_MENULINE_MEN2  " 2 -> Start Application 2\n"
#endif
#endif
...
bit ASMN_FRApplications( u08 MenuCom )
{
...
//    case ASMN_MENUCODE_TEST1:
      UARTStatus = ApplFRStart_1( MenuCom );
      while(1);
//      break;
#endif
...
//    case ASMN_MENUCODE_TEST2:
      UARTStatus = ApplFRStart_2( MenuCom );
      while(1);
//      break;
#endif
