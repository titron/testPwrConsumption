    	...
    	switch( EE_RSCFD_InterruptFlag_Channel0_u08 )
    	{
    		...
    		case EE_RSCFD_INT_TXQ0:
    			...
    			EE_RSCFD_LastTxObjectChannel0_u08 = ( u08 )
    				( ee_rscfd_common_p[ UnitNumber_u08 ]->txq.sts[ EE_RSCFD_CHANNEL0 ].mc );
    			ee_rscfd_common_p[ UnitNumber_u08 ]->txq.sts[ EE_RSCFD_CHANNEL0 ].irq = 0;
    	...
    	switch( EE_RSCFD_InterruptFlag_Channel1_u08 )
    	{
    		...
    		case EE_RSCFD_INT_TXQ0:
    			...
    			EE_RSCFD_LastTxObjectChannel1_u08 = ( u08 )
    				( ee_rscfd_common_p[ UnitNumber_u08 ]->txq.sts[ EE_RSCFD_CHANNEL1 ].mc );
    			ee_rscfd_common_p[ UnitNumber_u08 ]->txq.sts[ EE_RSCFD_CHANNEL1 ].irq = 0;
    			EE_RSCFD_CIVector[ ( EE_RSCFD_INT_MACRO * UnitNumber_u08 ) + EE_RSCFD_INT_GLOBAL + EE_RSCFD_INT_TXQ0 +
    												 ( EE_RSCFD_INT_CHANNEL * EE_RSCFD_CHANNEL1 ) ]( );
#else
    			EE_RSCFD_LastTxObjectChannel1_u08 = ( u08 )
    	...
    	switch( EE_RSCFD_InterruptFlag_Channel2_u08 )
    	{
    		...
    		case EE_RSCFD_INT_TXQ0:
    			...
    			EE_RSCFD_LastTxObjectChannel2_u08 = ( u08 )
    				( ee_rscfd_common_p[ UnitNumber_u08 ]->txq.sts[ EE_RSCFD_CHANNEL2 ].mc );
    			ee_rscfd_common_p[ UnitNumber_u08 ]->txq.sts[ EE_RSCFD_CHANNEL2 ].irq = 0;
    			EE_RSCFD_CIVector[ ( EE_RSCFD_INT_MACRO * UnitNumber_u08 ) + EE_RSCFD_INT_GLOBAL + EE_RSCFD_INT_TXQ0 +
    												 ( EE_RSCFD_INT_CHANNEL * EE_RSCFD_CHANNEL2 ) ]( );
#else
    			EE_RSCFD_LastTxObjectChannel2_u08 = ( u08 )
    	...
    	switch( EE_RSCFD_InterruptFlag_Channel3_u08 )
    	{
    		...
    		case EE_RSCFD_INT_TXQ0:
    			...
    			EE_RSCFD_LastTxObjectChannel3_u08 = ( u08 )
    				( ee_rscfd_common_p[ UnitNumber_u08 ]->txq.sts[ EE_RSCFD_CHANNEL3 ].mc );
    			ee_rscfd_common_p[ UnitNumber_u08 ]->txq.sts[ EE_RSCFD_CHANNEL3 ].irq = 0;
    			EE_RSCFD_CIVector[ ( EE_RSCFD_INT_MACRO * UnitNumber_u08 ) + EE_RSCFD_INT_GLOBAL + EE_RSCFD_INT_TXQ0 +
    												 ( EE_RSCFD_INT_CHANNEL * EE_RSCFD_CHANNEL3 ) ]( );
#else
    			EE_RSCFD_LastTxObjectChannel3_u08 = ( u08 )
    	...
    	switch( EE_RSCFD_InterruptFlag_Channel4_u08 )
    	{
    		...
    		case EE_RSCFD_INT_TXQ0:
    			...
    			EE_RSCFD_LastTxObjectChannel4_u08 = ( u08 )
    				( ee_rscfd_common_p[ UnitNumber_u08 ]->txq.sts[ EE_RSCFD_CHANNEL4 ].mc );
    			ee_rscfd_common_p[ UnitNumber_u08 ]->txq.sts[ EE_RSCFD_CHANNEL4 ].irq = 0;
    			EE_RSCFD_CIVector[ ( EE_RSCFD_INT_MACRO * UnitNumber_u08 ) + EE_RSCFD_INT_GLOBAL + EE_RSCFD_INT_TXQ0 +
    												 ( EE_RSCFD_INT_CHANNEL * EE_RSCFD_CHANNEL4 ) ]( );
#else
    			EE_RSCFD_LastTxObjectChannel4_u08 = ( u08 )
    	...
    	switch( EE_RSCFD_InterruptFlag_Channel5_u08 )
    	{
    		...
    		case EE_RSCFD_INT_TXQ0:
    			...
    			EE_RSCFD_LastTxObjectChannel5_u08 = ( u08 )
    				( ee_rscfd_common_p[ UnitNumber_u08 ]->txq.sts[ EE_RSCFD_CHANNEL5 ].mc );
    			ee_rscfd_common_p[ UnitNumber_u08 ]->txq.sts[ EE_RSCFD_CHANNEL5 ].irq = 0;
    			EE_RSCFD_CIVector[ ( EE_RSCFD_INT_MACRO * UnitNumber_u08 ) + EE_RSCFD_INT_GLOBAL + EE_RSCFD_INT_TXQ0 +
    												 ( EE_RSCFD_INT_CHANNEL * EE_RSCFD_CHANNEL5 ) ]( );
#else
    			EE_RSCFD_LastTxObjectChannel5_u08 = ( u08 )
    	...
    	switch( EE_RSCFD_InterruptFlag_Channel6_u08 )
    	{
    		...
    		case EE_RSCFD_INT_TXQ0:
    			...
    			EE_RSCFD_LastTxObjectChannel6_u08 = ( u08 )
    				( ee_rscfd_common_p[ UnitNumber_u08 ]->txq.sts[ EE_RSCFD_CHANNEL6 ].mc );
    			ee_rscfd_common_p[ UnitNumber_u08 ]->txq.sts[ EE_RSCFD_CHANNEL6 ].irq = 0;
    			EE_RSCFD_CIVector[ ( EE_RSCFD_INT_MACRO * UnitNumber_u08 ) + EE_RSCFD_INT_GLOBAL + EE_RSCFD_INT_TXQ0 +
    												 ( EE_RSCFD_INT_CHANNEL * EE_RSCFD_CHANNEL6 ) ]( );
#else
    			EE_RSCFD_LastTxObjectChannel6_u08 = ( u08 )
    	...
    	switch( EE_RSCFD_InterruptFlag_Channel7_u08 )
    	{
    		...
    		case EE_RSCFD_INT_TXQ0:
    			...
    			EE_RSCFD_LastTxObjectChannel7_u08 = ( u08 )
    				( ee_rscfd_common_p[ UnitNumber_u08 ]->txq.sts[ EE_RSCFD_CHANNEL7 ].mc );
    			ee_rscfd_common_p[ UnitNumber_u08 ]->txq.sts[ EE_RSCFD_CHANNEL7 ].irq = 0;
    			EE_RSCFD_CIVector[ ( EE_RSCFD_INT_MACRO * UnitNumber_u08 ) + EE_RSCFD_INT_GLOBAL + EE_RSCFD_INT_TXQ0 +
    											 ( EE_RSCFD_INT_CHANNEL * EE_RSCFD_CHANNEL7 ) ]( );
#else
    			EE_RSCFD_LastTxObjectChannel7_u08 = ( u08 )
                           ...
                           u16 InterruptSubSelection_u08 )
{
  ...
  else
  {
    ...
    switch( InterruptSelection_u08 )
      ...
      case EE_RSCFD_INT_TXQ0:
#ifdef RH850_F1H_RSCFD20
        ee_rscfd_common_p[ UnitNumber_u08 ]->txq.cc[ ChannelNumber_u08 ].ie =
          InterruptSubSelection_u08;
#else
...
{    
  ...
  ee_rscfd_common_p[ UnitNumber_u08 ]->gctr.gslpr = 0;
  while( ee_rscfd_common_p[ UnitNumber_u08 ]->gsts.slps );
  ...
  testsfrAddress = &(ee_rscfd_common_p[ UnitNumber_u08 ]->cfdgrmcfg);
	testsfrAddress = &(ee_rscfd_common_p[ UnitNumber_u08 ]->fdch[0].dcfg);
	ee_rscfd_common_p[ UnitNumber_u08 ]->cfdgrmcfg = 0x01;
...
{  
  ...
  else
  {
    ...
    testValue=EE_RSCFD_MAXBAUDRATEPLLBP;
...
#else
  testsfrAddress =&(ee_rscfd_common_p[ UnitNumber_u08 ]->fdch[ ChannelNumber_u08 ].fdcfg);
//  testsfrValue = (u32)(Config->fdcfg);
  ee_rscfd_common_p[ UnitNumber_u08 ]->fdch[ ChannelNumber_u08 ].fdcfg =   Config->fdcfg;
  *(testsfrAddress) = 0x24000000;
#endif
#ifndef RH850_F1H_RSCFD20
  for( TXCounter_u08 = 0;
...
#ifdef RH850_F1H_RSCFD20
    ee_rscfd_common_p[ UnitNumber_u08 ]->
      txq.cc[ ChannelNumber_u08 ].dc =
      Config->txq.dc;
    ee_rscfd_common_p[ UnitNumber_u08 ]->
      txq.cc[ ChannelNumber_u08 ].im =
      Config->txq.im;
    ee_rscfd_common_p[ UnitNumber_u08 ]->
      txq.cc[ ChannelNumber_u08 ].ie =
      Config->txq.ie;
#else
    ee_rscfd_common_p[ UnitNumber_u08 ]->
  ...
  switch( Message->path )
  {
    ...
    case EE_RSCFD_PATH_TXQUEUE:   /* only one TX Queue abort at a time */
      ...
      else
      {
        ...
        {
#ifdef RH850_F1H_RSCFD20
          if( ee_rscfd_common_p[ UnitNumber_u08 ]->txq.cc
    ...
    case EE_RSCFD_PATH_MSGBOX:      /* search a free SendBox, if required */
    {
           ...
           SendBox_u08 <= LastBox_u08; )
      {
                ...
                EE_RSCFD_TMSTS_CLEAR )    /* check pending TRQ */
        {
               ...
               FIFONumber_u08++ )   /* check any TX Queue assignment */
          {
            ...
            if( ( ( u08 )( ee_rscfd_txqentries[ UnitNumber_u08 ]
                                              [ ChannelNumber_u08 ]
                                              [ FIFONumber_u08 ] -
                           ee_rscfd_common_p[ UnitNumber_u08 ]->txq.cc
        ...
        if( SendBoxOccupied_u08 == EE_RSCFD_CLEAR )
        {
          ...
          ee_rscfd_common_p[ UnitNumber_u08 ]->tmiec
                           [ ( EE_RSCFD_MAXTXBUFFERS * ChannelNumber_u08 +
                             SendBox_u08 ) ] |= ( u08 )
                             ( EE_RSCFD_TMIEC_SET_TMIE );
      ...
      else                               
      {
             ...
             SendBox_u08++ )
        {
          ...
          if( ee_rscfd_common_p[ UnitNumber_u08 ]->txq.cc
                               [ ChannelNumber_u08 ].qe )
          {
            if( !ee_rscfd_common_p[ UnitNumber_u08 ]->txq.sts
...
#ifdef RH850_F1H_RSCFD20
        ee_rscfd_common_p[ UnitNumber_u08 ]->txq.pctr
