                              ...
                              u08                      SendChannel_u08 )
{
  ...
  OutputMessage->hdr.id    = ( OutputMessage->hdr.id & 0x1FFFFFF0 ) + ( u32 )SendChannel_u08;
                        ...
                        u08 Channel2_u08 )
{
  ...
  EE_RSCFD_Status_bit =  EE_RSCFD_PortEnable( Unit1_u08,
                                              Channel1_u08 );
...
//																				 EE_RSCFD_CLEAR );
	...
	EE_RSCFD_Status_bit &= EE_RSCFD_SetChannelConfiguration( Unit1_u08,
                                                           Channel1_u08,
                                                           &EE_RSCFD_A_CHCFG_BASIC );
//  EE_RSCFD_Status_bit &= EE_RSCFD_SetChannelConfiguration( Unit2_u08,
//                                                           Channel2_u08,
//                                                           &EE_RSCFD_A_CHCFG_BASIC );
#if 1// Comment @20180628 by David
  EE_RSCFD_Status_bit &= EE_RSCFD_CreateInterrupt( Unit1_u08,
                                                   Channel1_u08,
                                                   EE_RSCFD_INT_TX,
                                                   EE_RSCFD_INTENABLEDEFAULT,
                                                   RSCFD_A_UnitChannel1TransmitIRQ );
#endif
//  can_set_interrupt();// Added @20180628 by David
//  EE_RSCFD_Status_bit &= EE_RSCFD_SetAFLEntry( Unit2_u08,
//                                               Channel2_u08,
//												 0,
//                                               FilterEntry );
...
//                                         EE_RSCFD_SET );         /* timestamp reset */
  ...
  EE_RSCFD_Status_bit &= EE_RSCFD_SendMessage( Unit1_u08,
                                               Channel1_u08,
                                               &SendStatus_u08,
                                               &SendMessage );
...
//  if( EE_RSCFD_A_IRQ_TRX_0 == 0 ) return( EE_RSCFD_ERROR );
#if 0
  ...
  if( TimeoutLimit_u32 == 0L ) EE_RSCFD_Status_bit = EE_RSCFD_ERROR;
                            ...
                            u08 Channel2_u08 )
{
  ...
  EE_RSCFD_Status_bit &= EE_RSCFD_SetAFLEntry( Unit1_u08,
                                               Channel2_u08,
																							 0,
                                               FilterEntry );
                               ...
                               u08 Channel_u08 )
{
  ...
  EE_RSCFD_Status_bit &= EE_RSCFD_SendMessage( Unit_u08,
                                               Channel_u08,
                                               &SendStatus_u08,
                                               &SendMessage );
...
bit EE_RSCFD_SW_Gateway( u08 Unit_u08,
                         u08 ChannelCount_u08 )
{
  ...
  struct ee_rscfd_a_afl *FilterEntry_Gateway = &EE_RSCFD_A_AFL_RXFIFO_STDID_SWGW;
  struct ee_rscfd_a_afl *FilterEntry_Control = &EE_RSCFD_A_AFL_RXBOX_EXTID_SWGWCTRL;
  ...
  if( ( ChannelCount_u08 < 2 ) || ( ChannelCount_u08 > ee_rscfd_channels[ Unit_u08 ] ) )
    return( EE_RSCFD_ERROR );
       ...
       CurrentChannel_u08++ )
  {
    ...
    EE_RSCFD_Status_bit &= EE_RSCFD_PortEnable( Unit_u08, CurrentChannel_u08 );
    
    /* Set configuration (bitrate etc) */
    
    EE_RSCFD_Status_bit &= EE_RSCFD_SetChannelConfiguration( Unit_u08,
                                                             CurrentChannel_u08,
                                                             &EE_RSCFD_A_CHCFG_500_KBPS_4000KBPS );
    ...
    EE_RSCFD_Status_bit &= EE_RSCFD_CreateInterrupt( Unit_u08,
                                                     ...
                                                     EE_RSCFD_INT_TXHL,
                                                     EE_RSCFD_INTENABLEDEFAULT,
                                                     RSCFD_A_GatewayTransmitIRQ );

    EE_RSCFD_Status_bit &= EE_RSCFD_CreateInterrupt( Unit_u08,
                                                     EE_RSCFD_GLOBAL,
                                                     EE_RSCFD_INT_RXF0 + CurrentChannel_u08,
                                                     EE_RSCFD_INTENABLEDEFAULT,
                                                     RSCFD_A_GatewayReceiveIRQ );
          ...
          {  
                ...
                ( ReceiveStatus_u08   == EE_RSCFD_FAULT_NONE ) )
            {
                   ...
                   SendChannel_u08++ )
              {
                ...
                {
                  EE_RSCFD_GatewayPrepare( &GW_Message, SendChannel_u08 );
                  TimeoutLimit_u32 = EE_RSCFD_A_TIMEOUT_LIMIT;
                  ...
                  } while( ( SendStatus_u08 == EE_RSCFD_FAULT_BUSY ) &&
                           ( --TimeoutLimit_u32 > 0 ) );
                }
              }    
            }
