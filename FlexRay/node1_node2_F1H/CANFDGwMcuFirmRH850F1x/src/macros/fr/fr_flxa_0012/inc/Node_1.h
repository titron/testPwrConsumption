...
//#define LT                          1283846846       /* SUCC2 (pdListenTimeout), 1284~ 1283846uT */
#define LT                          1284       /* SUCC2 (pdListenTimeout) */

#define SPP                         0             /* PRTC1: Strobe Point Position, 00B in current rev.2.1 */
#define BRP                         0             /* PRTC1: Baud Rate Prescaler */
#define RWP                         2             /* PRTC1 (pWakeupPattern), 2~63 */
#define SLT                         0             /* MHDC (pLatestTx), 0~7981 */

//#define UT                          640000        /* GTUC1 (pMicroPerCycle), 640~640000uT *//* comment @Titron */
#define UT                          6000        /* GTUC1 (pMicroPerCycle), 640~640000uT *//* comment @Titron */

#define UIOA                        4             /* GTUC3 (pMicroInitialOffset[A]), 0~240uT */
#define UIOB                        4             /* GTUC3 (pMicroInitialOffset[B]), 0~240uT */
#define MIOA                        5             /* GTUC3 (pMacroInitialOffset[A]), 2~72MT */
#define MIOB                        5             /* GTUC3 (pMacroInitialOffset[B]), 2~72MT */
#define DCA                         0             /* GTUC5 (pDelayCompensation[A]), 0~200uT */
#define DCB                         0             /* GTUC5 (pDelayCompensation[B]), 0~200uT */
#define CDD                         1             /* GTUC5 (pClusterDriftDamping), 0~20uT */
...
#define EOC                         0             /* GTUC11 (pExternOffsetCorrection), 0~7uT */
#define ERC                         0             /* GTUC11 (pExternRateCorrection), 0~7uT */
