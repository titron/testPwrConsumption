...
// D-40472 Duesseldorf
//============================================================================
// Purpose: Timer Y Primitive Access Interface Function Header
//
//Warranty Disclaimer
//
...
#ifndef _ASMN_TIMERY_P_ASMNIF_H
#define _ASMN_TIMERY_P_ASMNIF_H

extern unsigned char ASMN_TimerYFunctions( u08 MenuCom );
