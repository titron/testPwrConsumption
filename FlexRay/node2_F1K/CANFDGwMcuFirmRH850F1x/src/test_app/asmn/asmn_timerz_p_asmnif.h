...
// D-40472 Duesseldorf
//============================================================================
// Purpose: Timer Z Primitive Access Interface Function Header
//
//Warranty Disclaimer
//
...
#ifndef _ASMN_TIMERZ_P_ASMNIF_H
#define _ASMN_TIMERZ_P_ASMNIF_H

extern unsigned char ASMN_TimerZFunctions( u08 MenuCom );
