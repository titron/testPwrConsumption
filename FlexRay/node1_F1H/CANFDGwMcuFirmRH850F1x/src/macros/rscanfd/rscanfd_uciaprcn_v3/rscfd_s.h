...
#define EE_RSCFD_A_TXQ_ALL   { EE_RSCFD_TXQ_ON, 0, 0, 0, \
...
#ifdef RH850_F1H_RSCFD20
#ifdef RH850_F1H_RSCFD20_OSC
#define EE_RSCFD_A_500K { 1, 0, 0, 9, 0, 4, 0 }   /* Automatic bit timing */
#define EE_RSCFD_B_2000K { 0, 0, 0, 3, 0, 2, 0 }   /* Automatic bit timing */
#else
#define EE_RSCFD_A_500K { 3, 0, 0, 12, 0, 5, 0 }   /* Automatic bit timing */
#define EE_RSCFD_B_2000K { 0, 0, 0, 12, 0, 5, 0 }   /* Automatic bit timing */
#endif
#else
...
#ifdef RH850_F1H_RSCFD20
  EE_RSCFD_A_500K,                     /* automatic arbitration bit timing */
  EE_RSCFD_B_2000K,                            /* automatic data bit timing */
#else
...
#ifdef RH850_F1H_RSCFD20
#ifdef RH850_F1H_RSCFD20_OSC
	EE_RSCFD_CLOCK_MOSC,                              /* use peripheral clock */
#else
