...
// D-40472 Duesseldorf
//============================================================================
// Purpose: Timer P Primitive Access Interface Function Header
//
//Warranty Disclaimer
//
...
#ifndef _ASMN_TIMER_PP_ASMNIF_H
#define _ASMN_TIMER_PP_ASMNIF_H

extern unsigned char ASMN_TimerPFunctions( u08 MenuCom );
