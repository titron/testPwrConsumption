...
// D-40472 Duesseldorf
//============================================================================
// Purpose: DMAC Primitive Access Interface
//
//Warranty Disclaimer
//
...
/* DMAC Driver Interface */
#include <map_dmac.h>

/* Basic ASMN Configuration, dependent on device specifics */
#include <map_asmn.h>

#define ASMN_MENULINE_HDR1  "    DMA TEST MONITOR\n"
#define ASMN_MENULINE_HDR2  "  (C) HS 12/1999    \n\n"
...
DisplayMainMenu( unsigned int  MenuCom,
                 char         *MenuCommand )
{
...
unsigned char
ASMN_DMACFunctions( unsigned int MenuCom )
{
