...
// DATE    = $Date: 2004-02-09 15:31:27 +0100 (Mo, 09 Feb 2004) $
//============================================================================
// C O P Y R I G H T
//============================================================================
...
// D-40472 Duesseldorf
//============================================================================
// Purpose: UART C Primitive Access Interface Function Header
//
//Warranty Disclaimer
//
...
//
// $Log$
// Revision 1.2  2004/02/09 14:31:27  liederr
// Missing include nec_types.h added.
//
...
#ifndef _ASMN_UARTC_P_ASMNIF_H
#define _ASMN_UARTC_P_ASMNIF_H

#include <nec_types.h>

extern unsigned char ASMN_UARTCFunctions( u08 MenuCom );
