...
//=============================================================================
  ...
  value_u32 = 0;
  value_u32 |= ( SFDL & 0x7F );     // Static Frame Data Length [6:0]                  
  ...
  value_u32 = 0;
  value_u32 |= ( UT   & 0xFFFFF );    // Microtick per Cycle [19:0]                            
  FrDrv_write_32bit ( GTUC1_REG, value_u32 );
                                   
  //CCCR, GTUC2 - GTU Configuration Register 2 (0x00A4)
  value_u32 = 0;
  value_u32 |= ( MPC  & 0x3FFF );   // Macrotick Per Cycle [13:0]                        
  ...
  value_u32 = 0;
  value_u32 |= ( NIT  & 0x3FFF );   // Network Idle Time Start [13:0]                                
  value_u32 |= ( OCS  & 0x3FFF )  << 16;  // Offset Correction Start [13:0]              
  ...
  value_u32 = 0;
  value_u32 |= ( SSL  & 0x7FF );      // Static Slot Length [10:0]                                 
