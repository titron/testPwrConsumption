...
// DATE    = $Date: 2004-02-10 11:53:21 +0100 (Di, 10 Feb 2004) $
//============================================================================
// C O P Y R I G H T
//============================================================================
...
// D-40472 Duesseldorf
//============================================================================
// Purpose: DMAC Primitive Access Interface Function Header
//
//Warranty Disclaimer
//
...
//
// $Log$
// Revision 1.1  2004/02/10 10:53:21  liederr
// Initial creation.
//
//
//============================================================================

#ifndef _ASMN_DMAC_P_ASMNIF_H
#define _ASMN_DMAC_P_ASMNIF_H

extern unsigned char ASMN_DMACFunctions( unsigned int MenuCom );
