...
// D-40472 Duesseldorf
//============================================================================
// Purpose: Timer Z Application Access Interface
//
//Warranty Disclaimer
//
...
#define ASMN_MENULINE_HDR1  "TIMER Z APPLICATION MENU\n"
...
u08 ApplTimerZInterval( u08 MenuCom )
{
  ...
  if( SuccessFlag == TMZ_OK ) {
    ...
    SuccessFlag = TMZ_SetInterval( ( u08 )UnitNumber,
                                   ( u08 )ClockSelection,
                                   OSCILLATOR_FREQUENCY,
                                   Interval,
                                   ( u08 )IRQLevel,
                                   TestTimerZ_A_IRQNotifier );
  }
...
unsigned char ASMN_TimerZApplications( u08 MenuCom )
{
  ...
  while( ( UARTStatus  == ASMN_UARTTRANSFEROK ) && 
    ...
    case ASMN_MENUCODE_INTERVAL:
      UARTStatus = ApplTimerZInterval( MenuCom );
      break;
