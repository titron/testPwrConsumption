...
u08  RLIN3_LIN_ActiveUnit_u08[RLIN3_MAXMACROS] =
 {RLIN3_NP, RLIN3_NP, RLIN3_NP, RLIN3_NP, RLIN3_NP, RLIN3_NP, RLIN3_NP, RLIN3_NP};
...
static volatile u32 temp = 0;
static volatile u32 trace_rlin3_state[64];

void RLIN3_LINS_IRQSend( u08 UnitNumber_u08 )
{
...
//  if(UnitNumber_u08 == 0){
//    trace_rlin3_state[count] = (u32)0x80000000 | ((u32)(RLIN3_LINSF_State_u08[ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08]]));
//    count++;
//
//    if(count >= 9){
//        temp = 0xFF;
...
//  }
  ...
  if( RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] == RLIN3_NP ) return;  /* invalid channel */
    
  RLIN3_LINGetStatus( RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08],
                      &HeaderReceived_u08,
                      &DataReceived_u08,
                      &DataTransmitted_u08,
                      &PID_u08 );

  switch( RLIN3_LINSF_State_u08[ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ] )
  {
    case RLIN3_A_LIN_STATE_TXDATA:
      if( !DataTransmitted_u08 )
      {
        RLIN3_LINSF_State_u08[ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ] = RLIN3_A_LIN_STATE_DLLERROR;
      }
      else
      {
        RLIN3_LINSF_State_u08[ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ] = RLIN3_A_LIN_STATE_IDLE;
        RLIN3_LINSReceiveAction( RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08],
                                 RLIN3_A_GETHEADER,
                                 0,
                                 0 );
      }
    ...
    default:
      if( !( RLIN3_LINSF_State_u08[ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ] & RLIN3_A_LIN_STATE_ERROR ) )
        RLIN3_LINSF_State_u08[ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ] = RLIN3_A_LIN_STATE_DLLERROR;
      break;      
  }
}

void RLIN3_LINS_IRQReceive( u08 UnitNumber_u08  )
{
  u08 HeaderReceived_u08;
  u08 DataReceived_u08;
  u08 DataTransmitted_u08;
...
//  if(UnitNumber_u08 == 0){
//    if(count == 0){
//    	memset(trace_rlin3_state, 0x00, sizeof(trace_rlin3_state));
//    }
//    trace_rlin3_state[count] = RLIN3_LINSF_State_u08[ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ];
//    count++;
//
//    if(count >= 9){
//	temp = 0xFF;
...
//  }
  ...
  switch( RLIN3_LINSF_State_u08[ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ] )
  {
    case RLIN3_A_LIN_STATE_SLEEP:
      RLIN3_LINSF_State_u08[ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ] = RLIN3_A_LIN_STATE_WAKEUP;
      break;
        ...
        switch( RLIN3_A_TAB_SLAVE_BASE[ TableIndex_u08 ].Type_u08 )
        {
          case RLIN3_A_NO:
            ...
            {                /* verify the reception of a SLEEP instruction */
              RLIN3_LINSF_State_u08[ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ] = RLIN3_A_LIN_STATE_RXSLEEP;
              RLIN3_LINMF_TableIndex_u08[ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ] = TableIndex_u08;
              RLIN3_LINSReceiveAction( RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08],
                                       RLIN3_A_GETMESSAGE, 
          ...
          case RLIN3_A_TX:   /* PID matches, a response must be sent */
            if( RLIN3_LINSF_SlaveResponseEnable_bit[ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ] == RLIN3_OK )
            {                /* give response in case that this is activated */
              RLIN3_LINSF_State_u08[ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ] = RLIN3_A_LIN_STATE_TXDATA;
              RLIN3_LINMF_TableIndex_u08[ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ] = TableIndex_u08;

              for( DataIndex_u08 = 0;
                   DataIndex_u08 < RLIN3_A_TAB_SLAVE_BASE
                                   [ RLIN3_LINMF_TableIndex_u08[ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ] ]
                                   .DataLength_u08;
                   DataIndex_u08++ )
              {
                RLIN3_LINM_Buffer[ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ]
                                       .Data[ DataIndex_u08 ] = 
                                       RLIN3_A_TAB_SLAVE_BASE[ TableIndex_u08 ]
                                                             .Data[ DataIndex_u08 ];
              }

              RLIN3_LINSendMessage( RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08],
                                    RLIN3_A_TAB_SLAVE_BASE[ TableIndex_u08 ]
                                                              .PID_u08,
                                    ( u16 )( RLIN3_A_TAB_SLAVE_BASE
                                            [ TableIndex_u08 ].DataLength_u08 ),
          ...
          case RLIN3_A_RX:   /* PID matches, a response must be received */
            RLIN3_LINSF_State_u08[ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ] = RLIN3_A_LIN_STATE_RXDATA;
            RLIN3_LINMF_TableIndex_u08[ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ] = TableIndex_u08;
            RLIN3_LINSReceiveAction( RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08],
                                     RLIN3_A_GETMESSAGE, 
                                     ( u16 )( RLIN3_A_TAB_SLAVE_BASE
          ...
          default:
            RLIN3_LINSF_State_u08[ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ] = RLIN3_A_LIN_STATE_FSMERROR;
            break;
        }
      }
      else
      {
        RLIN3_LINSF_State_u08[ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ] = RLIN3_A_LIN_STATE_UNEXRECV;
      }
      break;
    ...
    case RLIN3_A_LIN_STATE_RXSLEEP:
      ...
      {
        RLIN3_LINSF_State_u08[ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ] = RLIN3_A_LIN_STATE_IDLE;
        RLIN3_LINReceiveMessage( RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08],
        ...
        RLIN3_LINSF_State_u08[ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ] = RLIN3_A_LIN_STATE_SLEEP;
        ...
        for( TableIndex_u08 = 0;
             ...
             TableIndex_u08++ )
        {
          if( RLIN3_LINM_Buffer[ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ].Data[ TableIndex_u08 ] !=
              RLIN3_A_TAB_SLAVE_BASE[ RLIN3_LINMF_TableIndex_u08
                                    [ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ] ]
                                     .Data[ TableIndex_u08 ] )
          {
        ...
        if( RLIN3_LINSF_State_u08[ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ] == RLIN3_A_LIN_STATE_IDLE )
        {
          RLIN3_LINSReceiveAction( RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08],
                                   RLIN3_A_GETHEADER,
                                   0,
    ...
    case RLIN3_A_LIN_STATE_RXDATA:
      ...
      {
        RLIN3_LINSF_State_u08[ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ] = RLIN3_A_LIN_STATE_NEWSDATA;
        RLIN3_LINReceiveMessage( RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08],
                                 RLIN3_A_TAB_SLAVE_BASE[ RLIN3_LINMF_TableIndex_u08
                                                       [ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ] ]
                                                         .DataLength_u08,
...
void RLIN3_LINM_IRQSend( u08 UnitNumber_u08  )
{
  u08 HeaderReceived_u08;
  u08 DataReceived_u08;
  u08 DataTransmitted_u08;
    ...
    case RLIN3_A_LIN_STATE_TXBREAK:
      if( DataTransmitted_u08 )
      {
        if( RLIN3_A_TAB_MASTER_BASE[ RLIN3_LINMF_CurTable_u08
                                   ...
                                   [ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ] ].Type_u08 ==
                                     RLIN3_A_NO )
        {
          RLIN3_LINSF_State_u08[ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ] = RLIN3_A_LIN_STATE_SLEEP;
        }
...
void RLIN3_LINM_IRQReceive( u08 UnitNumber_u08 )
{
  u08 HeaderReceived_u08;
  u08 DataReceived_u08;
  u08 DataTransmitted_u08;
      ...
      if( DataReceived_u08 )
      {
        ...
        for( DataIndex_u08 = 0;
             DataIndex_u08 < RLIN3_A_TAB_MASTER_BASE
                             [ RLIN3_LINMF_CurTable_u08[ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ] ]
                             [ RLIN3_LINMF_TableIndex_u08[ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ] ]
                             .DataLength_u08;
             DataIndex_u08++ )
        {
          RLIN3_A_TAB_MASTER_BASE[ RLIN3_LINMF_CurTable_u08[ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ] ]
                                 [ RLIN3_LINMF_TableIndex_u08[ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ] ]
                                 .Data[ DataIndex_u08 ] =
                                 RLIN3_LINM_Buffer[ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ]
                                 .Data[ DataIndex_u08 ];
...
void RLIN3_LINM_IRQError( u08 UnitNumber_u08  )
{
  u08 AnyError_u08;
  u08 BitError_u08;
  ...
  RLIN3_LINGetError( RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08],
                     &AnyError_u08,
                     &BitError_u08,
  ...
  if( AnyError_u08 )
  {
    if( DataConsistencyError_u08 ) RLIN3_LINSF_State_u08[ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ] =
                                   RLIN3_A_LIN_STATE_DCCERROR;
    if( CheckSumError_u08 )        RLIN3_LINSF_State_u08[ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ] =
                                   RLIN3_A_LIN_STATE_CHSERROR;
      
    if( ( RLIN3_LINSF_State_u08[ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ] & RLIN3_A_LIN_STATE_ERROR ) !=
                                 RLIN3_A_LIN_STATE_ERROR )
    {
      RLIN3_LINSF_State_u08[ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ] =
                             RLIN3_A_LIN_STATE_DLLERROR; /* default error */
    }
  }
}

void RLIN3_LINS_IRQError( u08 UnitNumber_u08  )
{
  u08 AnyError_u08;
  u08 BitError_u08;
  u08 DataConsistencyError_u08;
  ...
  if( AnyError_u08 )
  {
    if( DataConsistencyError_u08 )     RLIN3_LINSF_State_u08
                                     [ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ] = RLIN3_A_LIN_STATE_DCCERROR;
    if( CheckSumError_u08 )            RLIN3_LINSF_State_u08
                                     [ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ] = RLIN3_A_LIN_STATE_CHSERROR;
    if( IdentParityError_u08 )         RLIN3_LINSF_State_u08
                                     [ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ] = RLIN3_A_LIN_STATE_PIDERROR;
    if( ResponsePreparationError_u08 ) RLIN3_LINSF_State_u08
                                     [ RLIN3_LIN_ActiveUnit_u08[UnitNumber_u08] ] = RLIN3_A_LIN_STATE_RPRERROR;
