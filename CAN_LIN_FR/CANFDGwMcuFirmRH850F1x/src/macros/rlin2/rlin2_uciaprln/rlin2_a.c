...
/* Frame index in one table which is currently used to communicate */
...
/* Table index which is currently used to communicate */
...
/* Start flag of 1st frame in the table. (= 1) respects that 1st frame of one table entry will be started.
 * (I don't think it is one good method that flag is used. It should use state machine to manage the process) */
...
//static volatile u32 trace_rlin21_state[64];
...
//  if((RLIN2_InterruptFlagUnit_u08 == 0) && (RLIN2_InterruptFlagChannel_u08 == 1)){
//    trace_rlin21_state[count] = (u32)0x80000000 | ((u32)(RLIN2_LINSF_State_u08[ RLIN2_InterruptFlagUnit_u08 ][ RLIN2_InterruptFlagChannel_u08 ]));
//    count++;
//
//    if(count >= 3){
//        temp = 0xFF;
...
//  if((RLIN2_InterruptFlagUnit_u08 == 0) && (RLIN2_InterruptFlagChannel_u08 == 1)){
//    trace_rlin21_state[count] = RLIN2_LINSF_State_u08[ RLIN2_InterruptFlagUnit_u08 ][ RLIN2_InterruptFlagChannel_u08 ];
//    count++;
//
//    if(count >= 3){
//        temp = 0xFF;
                       ...
                       flt Oscillator_Frequency_flt )
{
  ...
  LINStatus_bit = RLIN2_ResetOnChannel( UnitNumber_u08,
		                                ChannelNumber_u08);
...
typedef enum _LIN2MasterStateType
{
	LIN2MasterState_Init = 0,
	LIN2MasterState_Wakeup,
	LIN2MasterState_Tx_NewFrameOfTable,
	LIN2MasterState_Communicating,
}LIN2MasterStateType;

LIN2MasterStateType LIN2MasterState[RLIN2_MAXMACROS][RLIN2_MAXCHANNELS] =
{
    {LIN2MasterState_Init, LIN2MasterState_Init, LIN2MasterState_Init, LIN2MasterState_Init},
	{LIN2MasterState_Init, LIN2MasterState_Init, LIN2MasterState_Init, LIN2MasterState_Init},
	{LIN2MasterState_Init, LIN2MasterState_Init, LIN2MasterState_Init, LIN2MasterState_Init},
	{LIN2MasterState_Init, LIN2MasterState_Init, LIN2MasterState_Init, LIN2MasterState_Init},
	{LIN2MasterState_Init, LIN2MasterState_Init, LIN2MasterState_Init, LIN2MasterState_Init},
...
static volatile temp = 0;
bit RLIN2_LINMasterExecution_StateManage( u08 UnitNumber_u08,
                              u08 ChannelNumber_u08,
                              u08 TableNumber_u08,
                              u32 Baudrate_u32 )
{
  ...
  switch(LIN2MasterState[UnitNumber_u08][ChannelNumber_u08])
  {
  	  case LIN2MasterState_Init:
        LINStatus_bit =  RLIN2_LIN_SetMode( UnitNumber_u08,
  		                                      ChannelNumber_u08,
  		                                      Baudrate_u32,
  		                                      OSCILLATOR_FREQUENCY );
        ...
        LINStatus_bit &= RLIN2_LINM_SendWakeup( UnitNumber_u08, ChannelNumber_u08 );
        LIN2MasterState[UnitNumber_u08][ChannelNumber_u08] = LIN2MasterState_Wakeup;
  		  break;
  	  case LIN2MasterState_Wakeup:
        if( RLIN2_LINM_GetStatus( UnitNumber_u08, ChannelNumber_u08 ) != RLIN2_A_LIN_STATE_WAKEUP ){
        	LIN2MasterState[UnitNumber_u08][ChannelNumber_u08] = LIN2MasterState_Tx_NewFrameOfTable;
            LINStatus_bit &= RLIN2_LINM_SetTable( UnitNumber_u08,
									ChannelNumber_u08,
									TableNumber_u08 );
            LINStatus_bit &= RLIN2_LINM_RestartTable( UnitNumber_u08,
            ...
            if((UnitNumber_u08 == 0) && (ChannelNumber_u08 == 1)){
            	temp ++;
            }
        }
        break;
  	  case LIN2MasterState_Tx_NewFrameOfTable:
             if( RLIN2_A_TAB_MASTER_BASE[ RLIN2_LINMF_CurTable_u08[ UnitNumber_u08 ][ ChannelNumber_u08 ] ]
						               [ RLIN2_LINMF_TableIndex_u08[ UnitNumber_u08 ][ ChannelNumber_u08 ] + 1 ].Type_u08 !=
						               RLIN2_A_NO ) /* If the coming next frame of current table doesn't respect end, transmit it. */
             {
                 LINStatus_bit &= RLIN2_LINM_NextTableContent( UnitNumber_u08, ChannelNumber_u08 );	/* Tigger the transmission of new table */
                 LIN2MasterState[UnitNumber_u08][ChannelNumber_u08] = LIN2MasterState_Communicating;

                 if((UnitNumber_u08 == 0) && (ChannelNumber_u08 == 1)){
                 	temp ++;
                 }
             }else{
            	 // LHM: For rlin power test, the following code is to repeat the transmission of table
                 LINStatus_bit &= RLIN2_LINM_SetTable( UnitNumber_u08,
     									ChannelNumber_u08,
     									TableNumber_u08 );
                 LINStatus_bit &= RLIN2_LINM_RestartTable( UnitNumber_u08,
  		  ...
  		  break;
  	  case LIN2MasterState_Communicating:
        	ErrorStatus = RLIN2_LINM_GetStatus( UnitNumber_u08, ChannelNumber_u08 );
            if(ErrorStatus == RLIN2_A_LIN_STATE_IDLE)	/* Complete the transmission of one frame in one table*/
            {
            	LIN2MasterState[UnitNumber_u08][ChannelNumber_u08] = LIN2MasterState_Tx_NewFrameOfTable;
