                                      ...
                                      [ RLIN2_A_LIN_MAXTABLELENGTH ] =
{
  {      /* TYP   PID   LEN     DATA     [0xFF: Content is not relevant]     */
   ...
   { RLIN2_A_TX, 0x10, 0x08, { R_DATA, R_DATA, R_DATA, R_DATA, R_DATA, R_DATA, R_DATA, R_DATA } },
   { RLIN2_A_RX, 0x20, 0x08, { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 } },
   { RLIN2_A_NO, 0x3C, 0x08, { 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF } }
  },
  {
   { RLIN2_A_TX, 0x11, 0x08, { R_DATA, R_DATA, R_DATA, R_DATA, R_DATA, R_DATA, R_DATA, R_DATA } },
   { RLIN2_A_RX, 0x21, 0x08, { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 } },
   { RLIN2_A_NO, 0x3C, 0x08, { 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF } }
  },
  {
   { RLIN2_A_TX, 0x12, 0x08, { R_DATA, R_DATA, R_DATA, R_DATA, R_DATA, R_DATA, R_DATA, R_DATA } },
   { RLIN2_A_RX, 0x22, 0x08, { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 } },
   { RLIN2_A_NO, 0x3C, 0x08, { 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF } }
  },
  {
   { RLIN2_A_TX, 0x13, 0x08, { R_DATA, R_DATA, R_DATA, R_DATA, R_DATA, R_DATA, R_DATA, R_DATA } },
   { RLIN2_A_RX, 0x23, 0x08, { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 } },
   { RLIN2_A_NO, 0x3C, 0x08, { 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF } }
  },
  {
   { RLIN2_A_TX, 0x14, 0x08, { R_DATA, R_DATA, R_DATA, R_DATA, R_DATA, R_DATA, R_DATA, R_DATA } },
