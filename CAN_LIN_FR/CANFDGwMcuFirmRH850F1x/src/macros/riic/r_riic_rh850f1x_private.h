...
#ifndef RIIC_RH850F1X_PRIVATE_H
    #define RIIC_RH850F1X_PRIVATE_H
/***********************************************************************************************************************
 Includes   <System Includes> , "Project Includes"
 **********************************************************************************************************************/
/* Fixed width integer support. */
    #include "r_riic_rh850f1x_if.h"
    #include "r_riic_rh850f1x_config.h"
	#include "r_riic_rh850f1x_pin_config.h"
...
/* Include specifics for chosen MCU.  */
    ...
    #elif defined(BSP_MCU_RH850F1KH)
        #include "r_riic_rh850f1kh_private.h"
    #else
...
/* Bit position masks */
    ...
    #define RIIC_MAX_DIV              ((uint32_t)(0x08))
    #define RIIC_STAD_SPPED_MAX       ((uint32_t)(100))
    #define RIIC_FAST_SPPED_MAX       ((uint16_t)(400))
    #define RIIC_ICBR_MAX             ((uint32_t)(32))

/*----------------------------------------------------------------------------*/
/*   Define send data of blank.                                               */
/*----------------------------------------------------------------------------*/
    #define BLANK                     ((uint32_t)(0xFF))

/*----------------------------------------------------------------------------*/
/*   Define R/W code for slave address.                                       */
/*----------------------------------------------------------------------------*/
    #define W_CODE                    ((uint32_t)(0xFE))       /* Write code for slave address */
    #define R_CODE                    ((uint32_t)(0x01))       /* Read code for slave address */

/*----------------------------------------------------------------------------*/
/*   Define of port control.                                                  */
/*----------------------------------------------------------------------------*/
    #define RIIC_OUT                  ((uint32_t)(0x01))       /* Port Output */
    #define RIIC_IN                   ((uint32_t)(0x00))       /* Port Input */
...
/* Interrupt register setting */
    #define RIIC_IR_CLR             ((uint32_t)(0x00))       /* Clears interrupt request register. */
    #define RIIC_IR_SET             ((uint32_t)(0x01))       /* Sets interrupt request register. */
...
/* RIIC register setting */
    #define RIIC_ICCR1_NOT_DRIVEN   ((uint32_t)(0x00))       /* Clears ICCR1.ICE bit. */
    #define RIIC_ICCR1_ICE          ((uint32_t)(0x80))       /* ICCR1.ICE bit. */
    #define RIIC_ICCR1_ICE_SET      ((uint32_t)(0x80))       /* Sets ICCR1.ICE bit. */
    #define RIIC_ICCR1_ICE_CLR      ((uint32_t)(0x7F))       /* Clears ICCR1.ICE bit. */
    #define RIIC_ICCR1_RIIC_RESET   ((uint32_t)(0x40))       /* Sets ICCR1.IICRST bit. */
    #define RIIC_ICCR1_ENABLE       ((uint32_t)(0xBF))       /* Clears ICCR1.IICRST bit. */
    #define RIIC_ICCR1_CLO_SET      ((uint32_t)(0x20))       /* Sets ICCR1.CLO bit. */
    #define RIIC_ICCR1_SOWP         ((uint32_t)(0x10))       /* ICCR1.SOWP bit. */
    #define RIIC_ICCR1_SOWP_SET     ((uint32_t)(0x10))       /* Sets ICCR1.SOWP bit. */
    #define RIIC_ICCR1_SOWP_CLR     ((uint32_t)(0xEF))       /* Clears ICCR1.SOWP bit. */
    #define RIIC_ICCR1_SDAO_SCLO_SET ((uint32_t)(0x1F))      /* Clears ICCR1.SOWP bit. Sets ICCR1.SDAO and SCL0 bit*/
    #define RIIC_ICCR1_SDAI         ((uint32_t)(0x01))       /* Mask for ICCR1.SDAI bit. */
    #define RIIC_ICCR1_SDAI_SET     ((uint32_t)(0x01))       /* Sets for ICCR1.SDAI bit. */
    #define RIIC_ICCR1_SCLI         ((uint32_t)(0x02))       /* Mask for ICCR1.SCLI bit. */
    #define RIIC_ICCR1_SCLI_SET     ((uint32_t)(0x02))       /* Sets for ICCR1.SCLI bit. */
    #define RIIC_ICCR1_SDAO         ((uint32_t)(0x04))       /* Mask for ICCR1.SDAO bit. */
    #define RIIC_ICCR1_SDAO_SET     ((uint32_t)(0x04))       /* Sets for ICCR1.SDAO bit. */
    #define RIIC_ICCR1_SCLO         ((uint32_t)(0x08))       /* Mask for ICCR1.SCLO bit. */
    #define RIIC_ICCR1_SCLO_SET     ((uint32_t)(0x08))       /* Sets for ICCR1.SCLO bit. */
    #define RIIC_SAR0_INIT         ((uint32_t)(0x00))       /* Sets SARLy and SARUy.(y=0,1,2) */
//    #define RIIC_SARL0_INIT         ((uint32_t)(0x00))       /* Sets SARLy and SARUy.(y=0,1,2) */
//    #define RIIC_SARU0_INIT         ((uint32_t)(0x00))       /* Sets SARLy and SARUy.(y=0,1,2) */
    #define RIIC_SAR1_INIT         ((uint32_t)(0x00))       /* Sets SARLy and SARUy.(y=0,1,2) */
//    #define RIIC_SARL1_INIT         ((uint32_t)(0x00))       /* Sets SARLy and SARUy.(y=0,1,2) */
//    #define RIIC_SARU1_INIT         ((uint32_t)(0x00))       /* Sets SARLy and SARUy.(y=0,1,2) */
    #define RIIC_SAR2_INIT         ((uint32_t)(0x00))       /* Sets SARLy and SARUy.(y=0,1,2) */
//    #define RIIC_SARL2_INIT         ((uint32_t)(0x00))       /* Sets SARLy and SARUy.(y=0,1,2) */
//    #define RIIC_SARU2_INIT         ((uint32_t)(0x00))       /* Sets SARLy and SARUy.(y=0,1,2) */
    #define RIIC_SAR_MASK          ((uint16_t)(0x83FF))    /* Mask for SARLy setting. */
//    #define RIIC_SARL_MASK          ((uint16_t)(0x00FF))    /* Mask for SARLy setting. */
//    #define RIIC_SARU_MASK          ((uint16_t)(0x0300))    /* Mask for SARUy setting. */
    #define RIIC_SAR_10BIT_FORMAT_SET ((uint32_t)(0x8000))    /* Sets SARUy.FS bit. */
//    #define RIIC_SARU_10BIT_FORMAT_SET ((uint32_t)(0x01))    /* Sets SARUy.FS bit. */
    #define RIIC_ICSER_INIT         ((uint32_t)(0x00))       /* Sets ICSER */
    #define RIIC_ICSER_SAR_DASABLE  ((uint32_t)(0xF8))       /* Clears ICSER.SAR0E,SAR1E,SAR2E bit */
    #define RIIC_ICSER_SAR0E_SET    ((uint32_t)(0x01))       /* Sets ICSER.SAR0E bit */
    #define RIIC_ICSER_SAR0E_CLR    ((uint32_t)(0xFE))       /* Clears ICSER.SAR0E bit */
    #define RIIC_ICSER_SAR1E_SET    ((uint32_t)(0x02))       /* Sets ICSER.SAR1E bit */
    #define RIIC_ICSER_SAR1E_CLR    ((uint32_t)(0xFD))       /* Clears ICSER.SAR1E bit */
    #define RIIC_ICSER_SAR2E_SET    ((uint32_t)(0x04))       /* Sets ICSER.SAR2E bit */
    #define RIIC_ICSER_SAR2E_CLR    ((uint32_t)(0xFB))       /* Clears ICSER.SAR2E bit */
    #define RIIC_ICSER_GCAE_SET     ((uint32_t)(0x08))       /* Sets ICSER.GCAE bit */
    #define RIIC_ICSER_GCAE_CLR     ((uint32_t)(0xF7))       /* Clears ICSER.GCAE bit */
    #define RIIC_ICSER_DIDE_SET     ((uint32_t)(0x20))       /* Sets ICSER.DIDE bit */
    #define RIIC_ICSER_DIDE_CLR     ((uint32_t)(0xDF))       /* Clears ICSER.DIDE bit */

    #define RIIC_ICMR1_MTWP_SET     ((uint32_t)(0x80))       /* Sets ICMR1.MTWP bit. */
    #define RIIC_ICMR1_MTWP_CLR     ((uint32_t)(0x7F))       /* Clears ICMR1.MTWP bit. */
    #define RIIC_ICMR2_INIT         ((uint32_t)(0x00))       /* Sets ICMR2 */

    #if RIIC_CFG_NACK_AL_ENABLE == 0
        #define RIIC_NALE               ((uint32_t)(0x00))       /* Mask for ICFER.NALE bit. */
    #elif RIIC_CFG_NACK_AL_ENABLE == 1
        #define RIIC_NALE               ((uint32_t)(0x04))       /* Mask for ICFER.NALE bit. */
    #endif

    #if RIIC_CFG_SLAVE_AL_ENABLE == 0
        #define RIIC_SALE               ((uint32_t)(0x00))       /* Mask for ICFER.SALE bit. */
    #elif RIIC_CFG_SLAVE_AL_ENABLE == 1
        #define RIIC_SALE               ((uint32_t)(0x08))       /* Mask for ICFER.SALE bit. */
    #endif

    #if RIIC_CFG_NACK_SUSPEND_ENABLE == 0
        #define RIIC_NACKE              ((uint32_t)(0x00))       /* Mask for ICFER.NACKE bit. */
    #elif RIIC_CFG_NACK_SUSPEND_ENABLE == 1
        #define RIIC_NACKE              ((uint32_t)(0x10))       /* Mask for ICFER.NACKE bit. */
    #endif

    #if RIIC_CFG_SCL_SYNC_ENABLE == 0
        #define RIIC_SCLE               ((uint32_t)(0x00))       /* Mask for ICFER.SCLE bit. */
    #elif RIIC_CFG_SCL_SYNC_ENABLE == 1
        #define RIIC_SCLE               ((uint32_t)(0x40))       /* Mask for ICFER.SCLE bit. */
    #endif

    #define RIIC_ICCR2_ST           ((uint32_t)(0x02))       /* Mask for ICCR2.ST bit. */
    #define RIIC_ICCR2_RS           ((uint32_t)(0x04))       /* Mask for ICCR2.RS bit. */
    #define RIIC_ICCR2_SP           ((uint32_t)(0x08))       /* Mask for ICCR2.SP bit. */
    #define RIIC_ICCR2_TRS          ((uint32_t)(0x20))       /* Mask for ICCR2.TRS bit. */
    #define RIIC_ICCR2_TRS_SET      ((uint32_t)(0x20))       /* Sets ICCR2.TRS bit. */
    #define RIIC_ICCR2_TRS_CLR      ((uint32_t)(0xDF))       /* Clears ICCR2.TRS bit. */
    #define RIIC_ICCR2_MST          ((uint32_t)(0x40))       /* Mask for ICCR2.MST bit. */
    #define RIIC_ICCR2_MST_SET      ((uint32_t)(0x40))       /* Sets ICCR2.MST bit. */
    #define RIIC_ICCR2_BBSY         ((uint32_t)(0x80))       /* Mask for ICCR2.BBSY bit. */
    #define RIIC_ICCR2_BBSY_SET     ((uint32_t)(0x80))       /* Sets ICCR2.BBSY bit. */
    #define RIIC_ICMR2_TMWE         ((uint32_t)(0x08))       /* Mask for ICMR2.TMWE bit. */
    #define RIIC_ICMR2_TMWE_SET     ((uint32_t)(0x08))       /* Sets ICMR2.TMWE bit. */
    #define RIIC_ICMR2_TMWE_CLR     ((uint32_t)(0xF7))       /* Clear ICMR2.TMWE bit. */
    #define RIIC_ICMR3_WAIT_SET     ((uint32_t)(0x40))       /* Sets ICMR3.WAIT bit. */
    #define RIIC_ICMR3_WAIT_CLR     ((uint32_t)(0xBF))       /* Clears ICMR3.WAIT bit. */
    #define RIIC_ICMR3_RDRFS_SET    ((uint32_t)(0x20))       /* Sets ICMR3.RDRFS bit. */
    #define RIIC_ICMR3_RDRFS_CLR    ((uint32_t)(0xDF))       /* Clears ICMR3.RDRFS bit. */
    #define RIIC_ICMR3_ACKWP_SET    ((uint32_t)(0x10))       /* Sets ICMR3.ACKWP bit. */
    #define RIIC_ICMR3_ACKWP_CLR    ((uint32_t)(0xEF))       /* Clears ICMR3.ACKWP bit. */
    #define RIIC_ICMR3_ACKBT_SET    ((uint32_t)(0x08))       /* Sets ICMR3.ACKBT bit. */
    #define RIIC_ICMR3_ACKBT_CLR    ((uint32_t)(0xF7))       /* Clears ICMR3.ACKBT bit. */
    #define RIIC_ICSR1_AAS0         ((uint32_t)(0x01))       /* Mask for ICSR1.AAS0 bit. */
    #define RIIC_ICSR1_AAS0_SET     ((uint32_t)(0x01))       /* Sets ICSR1.AAS0 bit. */
    #define RIIC_ICSR1_AAS1         ((uint32_t)(0x02))       /* Mask for ICSR1.AAS1 bit. */
    #define RIIC_ICSR1_AAS1_SET     ((uint32_t)(0x02))       /* Sets ICSR1.AAS1 bit. */
    #define RIIC_ICSR1_AAS2         ((uint32_t)(0x04))       /* Mask for ICSR1.AAS2 bit. */
    #define RIIC_ICSR1_AAS2_SET     ((uint32_t)(0x04))       /* Sets ICSR1.AAS2 bit. */
    #define RIIC_ICSR1_GCA          ((uint32_t)(0x08))       /* Mask for ICSR1.GCA bit. */
    #define RIIC_ICSR1_GCA_SET      ((uint32_t)(0x08))       /* Sets ICSR1.GCA bit. */
    #define RIIC_ICSR1_DID          ((uint32_t)(0x20))       /* Mask for ICSR1.DID bit. */
    #define RIIC_ICSR1_DID_SET      ((uint32_t)(0x20))       /* Sets ICSR1.DID bit. */
    #define RIIC_ICSR1_HOA          ((uint32_t)(0x80))       /* Mask for ICSR1.HOA bit. */
    #define RIIC_ICSR1_HOA_SET      ((uint32_t)(0x80))       /* Sets ICSR1.HOA bit. */
    #define RIIC_ICSR2_TMOF         ((uint32_t)(0x01))       /* Mask for ICSR2.TMOF bit. */
    #define RIIC_ICSR2_TMOF_SET     ((uint32_t)(0x01))       /* Sets ICSR2.TMOF bit. */
    #define RIIC_ICSR2_AL           ((uint32_t)(0x02))       /* Mask for ICSR2.AL bit. */
    #define RIIC_ICSR2_AL_SET       ((uint32_t)(0x02))       /* Sets ICSR2.AL bit. */
    #define RIIC_ICSR2_AL_CLR       ((uint32_t)(0xFD))       /* Clears ICSR2.AL bit. */
    #define RIIC_ICSR2_START        ((uint32_t)(0x04))       /* Mask for ICSR2.START bit. */
    #define RIIC_ICSR2_START_SET    ((uint32_t)(0x04))       /* Sets ICSR2.START bit. */
    #define RIIC_ICSR2_START_CLR    ((uint32_t)(0xFB))       /* Clears ICSR2.START bit. */
    #define RIIC_ICSR2_STOP         ((uint32_t)(0x08))       /* Mask for ICSR2.STOP bit. */
    #define RIIC_ICSR2_STOP_SET     ((uint32_t)(0x08))       /* Sets ICSR2.STOP bit. */
    #define RIIC_ICSR2_STOP_CLR     ((uint32_t)(0xF7))       /* Clears ICSR2.STOP bit. */
    #define RIIC_ICSR2_NACKF        ((uint32_t)(0x10))       /* Mask for ICSR2.NACKF bit. */
    #define RIIC_ICSR2_NACKF_SET    ((uint32_t)(0x10))       /* Sets ICSR2.NACKF bit. */
    #define RIIC_ICSR2_NACKF_CLR    ((uint32_t)(0xEF))       /* Clears ICSR2.NACKF bit. */
    #define RIIC_ICSR2_RDRF         ((uint32_t)(0x20))       /* Mask for ICSR2.RDRF bit. */
    #define RIIC_ICSR2_RDRF_SET     ((uint32_t)(0x20))       /* Sets ICSR2.RDRF bit. */
    #define RIIC_ICSR2_TEND         ((uint32_t)(0x40))       /* Mask for ICSR2.TDRE bit. */
    #define RIIC_ICSR2_TEND_SET     ((uint32_t)(0x40))       /* Sets ICSR2.TDRE bit. */
    #define RIIC_ICSR2_TDRE         ((uint32_t)(0x80))       /* Mask for ICSR2.TDRE bit. */
    #define RIIC_ICSR2_TDRE_SET     ((uint32_t)(0x80))       /* Sets ICSR2.TDRE bit. */
    #define RIIC_ICSR2_DISABLE      ((uint32_t)(0xE7))       /* Clears ICSR2.NACKF bit and STOP bit. */

    #define RIIC_ICIER_INIT         ((uint32_t)(0x00))       /* Initializes ICIER. */
    #define RIIC_ICIER_INT_ENABLE   ((uint32_t)(0xFF))       /* Initializes ICIER. */
    #define RIIC_ICIER_INT_DISABLE   ((uint32_t)(0x00))       /* Initializes ICIER. */

	#define RIIC_IER_TMOIE_SET		((uint32_t)(0x01))
	#define RIIC_IER_ALIE_SET     	((uint32_t)(0x02))
	#define RIIC_IER_STIE_SET     	((uint32_t)(0x04))
	#define RIIC_IER_SPIE_SET     	((uint32_t)(0x08))
	#define RIIC_IER_NAKIE_SET     	((uint32_t)(0x10))
	#define RIIC_IER_RIE_SET     	((uint32_t)(0x20))
	#define RIIC_IER_TEIE_SET     	((uint32_t)(0x40))
	#define RIIC_IER_TIE_SET     	((uint32_t)(0x80))
	#define RIIC_IER_BIT_TMOIE 			(0x0)
	#define RIIC_IER_BIT_ALIE 			(0x1)
	#define RIIC_IER_BIT_STIE 			(0x2)
	#define RIIC_IER_BIT_SPIE 			(0x3)
	#define RIIC_IER_BIT_NAKIE 			(0x4)
	#define RIIC_IER_BIT_RIE 			(0x5)
	#define RIIC_IER_BIT_TEIE 			(0x6)
	#define RIIC_IER_BIT_TIE 			(0x7)

    #define RIIC_ICIER_ST_NAK_AL    ((uint32_t)(0x16))       /* Sets ICIER.STIE bit. */
/* Enable bit  : ALIE, STIE, NAKIE          */
/* Disable bit : TMOIE, SPIE, RIE, TEIE, TIE */
    #define RIIC_ICIER_SP_NAK_AL    ((uint32_t)(0x1A))       /* Sets ICIER.SPIE bit and NAKIE. */
/* Enable bit  : ALIE, SPIE, NAKIE          */
/* Disable bit : TMOIE, STIE, RIE, TEIE, TIE */
    #define RIIC_ICIER_TEND_NAK_AL  ((uint32_t)(0x52))       /* Sets ICIER.TEIE bit. */
/* Enable bit  : ALIE, NAKIE, TEIE          */
/* Disable bit : TMOIE, STIE, SPIE, RIE, TIE */
    #define RIIC_ICIER_RX_NAK_AL    ((uint32_t)(0x32))       /* Sets ICIER.RIE bit. */
/* Enable bit  : ALIE, NAKIE, RIE           */
/* Disable bit : TMOIE, STIE, SPIE, TEIE, TIE */
    #define RIIC_ICIER_SP_AL        ((uint32_t)(0x0A))       /* Sets ICIER.SPIE bit and clears ICIER.NAKIE bit. */
/* Enable bit  : ALIE, SPIE                 */
/* Disable bit : TMOIE, STIE, NAKIE, RIE, TEIE, TIE */
    #define RIIC_ICIER_AL           ((uint32_t)(0x02))       /* Sets ICIER.ALIE bit. */
/* Enable bit  : ALIE                       */
/* Disable bit : TMOIE, STIE, SPIE, NAKIE, RIE, TEIE, TIE */
    #define RIIC_ICIER_SP           ((uint32_t)(0x08))       /* Sets ICIER.SPIE bit. */
/* Enable bit  : SPIE                       */
/* Disable bit : TMOIE, ALIE, STIE, NAKIE, RIE, TEIE, TIE */
    #define RIIC_ICIER_TX_RX_SP_NAK_AL ((uint32_t)(0xBA))    /* Sets ICIER register. */
/* Enable bit  : ALIE, SPIE, NAKIE, RIE, TIE */
/* Disable bit : TMOIE, STIE, TEIE          */
    #define RIIC_ICIER_TX_SP_NAK_AL ((uint32_t)(0x9A))       /* Sets ICIER register. */
/* Enable bit  : ALIE, SPIE, NAKIE, TIE     */
/* Disable bit : TMOIE, STIE, TEIE, RIE     */
    #define RIIC_ICIER_RX_SP_NAK_AL ((uint32_t)(0x3A))       /* Sets ICIER register. */
/* Enable bit  : ALIE, SPIE, NAKIE, RIE     */
/* Disable bit : TMOIE, STIE, TEIE, TIE     */
    #define RIIC_ICIER_TX_RX_SP_NAK ((uint32_t)(0xB8))       /* Sets ICIER register. */
/* Enable bit  : SPIE, NAKIE, RIE, TIE      */
/* Disable bit : ALIE, TMOIE, STIE, TEIE    */
    #define RIIC_ICIER_TX_SP_NAK    ((uint32_t)(0x98))       /* Sets ICIER register. */
/* Enable bit  : SPIE, NAKIE, TIE           */
/* Disable bit : ALIE, TMOIE, STIE, TEIE, RIE */
    #define RIIC_ICIER_RX_SP        ((uint32_t)(0x28))       /* Sets ICIER register. */
/* Enable bit  : SPIE, RIE           */
/* Disable bit : ALIE, TMOIE, NAKIE, STIE, TEIE, TIE */
    #define RIIC_ICIER_TX_RX        ((uint32_t)(0xA0))       /* Sets ICIER register. */
/* Enable bit  : RIE, TIE                   */
/* Disable bit : SPIE, NAKIE, ALIE, TMOIE, STIE, TEIE */
    #define RIIC_ICIER_TX           ((uint32_t)(0x80))       /* Sets ICIER register. */
/* Enable bit  : TIE                        */
/* Disable bit : SPIE, NAKIE, ALIE, TMOIE, STIE, RIE, TEIE */
    #define RIIC_ICIER_RX           ((uint32_t)(0x20))       /* Sets ICIER register. */
/* Enable bit  : RIE                        */
/* Disable bit : SPIE, NAKIE, ALIE, TMOIE, STIE, TEIE, TIE */
    #define RIIC_ICIER_TMO          ((uint32_t)(0x01))       /* Sets ICIER register. */
/* Enable bit  : TMOIE                        */
    #define RIIC_MSK_BBSY           ((uint32_t)(0x80))       /* Mask ICCR2.BBSY bit  */
    #define RIIC_MSK_SCLSDA         ((uint32_t)(0x03))       /* Mask ICCR1.SDAI bit and SCLI bit */
    #define RIIC_SCLI_LOW           ((uint32_t)(0x00))       /* input SCL Low */
...
//    #define RIIC_ICCR1_ADR(n)    ( (volatile uint32_t *)&RIIC0 + 0x00 + ((32 * (n)) / sizeof(uint32_t)) )
//    #define RIIC_ICCR2_ADR(n)    ( (volatile uint32_t *)&RIIC0 + 0x01 + ((32 * (n)) / sizeof(uint32_t)) )
//    #define RIIC_ICMR1_ADR(n)    ( (volatile uint32_t *)&RIIC0 + 0x02 + ((32 * (n)) / sizeof(uint32_t)) )
//    #define RIIC_ICMR2_ADR(n)    ( (volatile uint32_t *)&RIIC0 + 0x03 + ((32 * (n)) / sizeof(uint32_t)) )
//    #define RIIC_ICMR3_ADR(n)    ( (volatile uint32_t *)&RIIC0 + 0x04 + ((32 * (n)) / sizeof(uint32_t)) )
//    #define RIIC_ICFER_ADR(n)    ( (volatile uint32_t *)&RIIC0 + 0x05 + ((32 * (n)) / sizeof(uint32_t)) )
//    #define RIIC_ICSER_ADR(n)    ( (volatile uint32_t *)&RIIC0 + 0x06 + ((32 * (n)) / sizeof(uint32_t)) )
//    #define RIIC_ICIER_ADR(n)    ( (volatile uint32_t *)&RIIC0 + 0x07 + ((32 * (n)) / sizeof(uint32_t)) )
//    #define RIIC_ICSR1_ADR(n)    ( (volatile uint32_t *)&RIIC0 + 0x08 + ((32 * (n)) / sizeof(uint32_t)) )
//    #define RIIC_ICSR2_ADR(n)    ( (volatile uint32_t *)&RIIC0 + 0x09 + ((32 * (n)) / sizeof(uint32_t)) )
//    #define RIIC_SARL0_ADR(n)    ( (volatile uint32_t *)&RIIC0 + 0x0A + ((32 * (n)) / sizeof(uint32_t)) )
//    #define RIIC_SARU0_ADR(n)    ( (volatile uint32_t *)&RIIC0 + 0x0B + ((32 * (n)) / sizeof(uint32_t)) )
//    #define RIIC_SARL1_ADR(n)    ( (volatile uint32_t *)&RIIC0 + 0x0C + ((32 * (n)) / sizeof(uint32_t)) )
//    #define RIIC_SARU1_ADR(n)    ( (volatile uint32_t *)&RIIC0 + 0x0D + ((32 * (n)) / sizeof(uint32_t)) )
//    #define RIIC_SARL2_ADR(n)    ( (volatile uint32_t *)&RIIC0 + 0x0E + ((32 * (n)) / sizeof(uint32_t)) )
//    #define RIIC_SARU2_ADR(n)    ( (volatile uint32_t *)&RIIC0 + 0x0F + ((32 * (n)) / sizeof(uint32_t)) )
//    #define RIIC_ICBRL_ADR(n)    ( (volatile uint32_t *)&RIIC0 + 0x10 + ((32 * (n)) / sizeof(uint32_t)) )
//    #define RIIC_ICBRH_ADR(n)    ( (volatile uint32_t *)&RIIC0 + 0x11 + ((32 * (n)) / sizeof(uint32_t)) )
//    #define RIIC_ICDRT_ADR(n)    ( (volatile uint32_t *)&RIIC0 + 0x12 + ((32 * (n)) / sizeof(uint32_t)) )
//    #define RIIC_ICDRR_ADR(n)    ( (volatile uint32_t *)&RIIC0 + 0x13 + ((32 * (n)) / sizeof(uint32_t)) )
extern uint32_t* RIIC_ICCR1_ADR(uint8_t n);
extern uint32_t* RIIC_ICCR2_ADR(uint8_t n);
extern uint32_t* RIIC_ICMR1_ADR(uint8_t n);
extern uint32_t* RIIC_ICMR2_ADR(uint8_t n);
extern uint32_t* RIIC_ICMR3_ADR(uint8_t n);
extern uint32_t* RIIC_ICFER_ADR(uint8_t n);
extern uint32_t* RIIC_ICSER_ADR(uint8_t n);
extern uint32_t* RIIC_ICIER_ADR(uint8_t n);
extern uint32_t* RIIC_ICSR1_ADR(uint8_t n);
extern uint32_t* RIIC_ICSR2_ADR(uint8_t n);
extern uint32_t* RIIC_SAR0_ADR(uint8_t n);
extern uint32_t* RIIC_SAR1_ADR(uint8_t n);
extern uint32_t* RIIC_SAR2_ADR(uint8_t n);
extern uint32_t* RIIC_ICBRL_ADR(uint8_t n);
extern uint32_t* RIIC_ICBRH_ADR(uint8_t n);
extern uint32_t* RIIC_ICDRT_ADR(uint8_t n);
extern uint32_t* RIIC_ICDRR_ADR(uint8_t n);



    #ifdef TN_RXA012A
        #define RIIC_TMOCNTL_ADR(n)  ( (volatile uint32_t *)&RIIC0 + 0x0A + ((32 * (n)) / sizeof(uint32_t)) )
        #define RIIC_TMOCNTH_ADR(n)  ( (volatile uint32_t *)&RIIC0 + 0x0B + ((32 * (n)) / sizeof(uint32_t)) )
    #endif

/* Base register of PCR used to calculate all PCR register addresses. This is constant for all supported MCUs. */
//    #define RIIC_PRV_PCR_BASE_REG ((uint32_t volatile *)(&MPC.PWPR.BYTE-95))
///* Base register of PDR used to calculate all PDR register addresses. This is constant for all supported MCUs. */
//    #define RIIC_PRV_PDR_BASE_REG ((uint32_t volatile *)(&MPC.PWPR.BYTE-287))
///* Base register of PMR used to calculate all PMR register addresses. This is constant for all supported MCUs. */
//    #define RIIC_PRV_PMR_BASE_REG ((uint32_t volatile *)(&MPC.PWPR.BYTE-191))
///* Base register of PFS used to calculate all PFS register addresses. This is constant for all supported MCUs. */
//    #define RIIC_PRV_PFS_BASE_REG ((uint32_t volatile *)(&MPC.PWPR.BYTE+33))
 ...
 **********************************************************************************************************************/
bool riic_mcu_check_channel (uint32_t channe);
void riic_mcu_int_init (uint32_t channe);
uint32_t riic_mcu_check_ir_txi (uint32_t channel);
uint32_t riic_mcu_check_ir_rxi (uint32_t channel);
void riic_mcu_clear_ir_txi (uint32_t channel);
void riic_mcu_clear_ir_rxi (uint32_t channel);
void riic_mcu_int_enable (uint32_t channe);
void riic_mcu_int_disable (uint32_t channe);
void riic_mcu_power_on (uint32_t channel);
void riic_mcu_power_off (uint32_t channel);
bool riic_mcu_hardware_lock (uint32_t channel);
void riic_mcu_hardware_unlock (uint32_t channel);
double riic_mcu_check_freq (void);
void riic_mcu_int_icier_setting (uint32_t channel, uint32_t New_icier);

    #if (1U == RIIC_CFG_PORT_SET_PROCESSING)
void riic_mcu_io_open (uint8_t channe);
//void riic_mcu_mpc_enable (uint32_t channe);
//void riic_mcu_mpc_disable (uint32_t channe);
    #endif
