...
static void riic_int_icier_setting (riic_info_t *, uint32_t New_icier);
...
static void riic_set_sending_data (riic_info_t *, uint32_t *p_data);
static uint32_t riic_get_receiving_data (riic_info_t *);
...
static void riic_getstatus (riic_info_t *p_riic_info, riic_mcu_status_t *p_riic_status)
{
    ...
    volatile uint32_t * const piccr1_reg = RIIC_ICCR1_ADR(p_riic_info->ch_no);
    volatile uint32_t * const piccr2_reg = RIIC_ICCR2_ADR(p_riic_info->ch_no);
    volatile uint32_t * const picsr1_reg = RIIC_ICSR1_ADR(p_riic_info->ch_no);
    volatile uint32_t * const picsr2_reg = RIIC_ICSR2_ADR(p_riic_info->ch_no);
...
static riic_return_t riic_control (riic_info_t * p_riic_info, uint8_t ctrl_ptn)
{
    ...
    {
        /* Set ICE bit to enable RIIC module */
            ...
            RIIC_GEN_RESET) & ctrl_ptn)))
    {
        ...
        if (RIIC_GEN_SDA_HI_Z == (ctrl_ptn & RIIC_GEN_SDA_HI_Z))
        {
            ...
            *piccr1_reg = (uint32_t) (((*piccr1_reg) | RIIC_ICCR1_SDAO_SET) & RIIC_ICCR1_SOWP_CLR);
        }
        ...
        if (RIIC_GEN_SCL_ONESHOT == (ctrl_ptn & RIIC_GEN_SCL_ONESHOT))
        {
            ...
            while (RIIC_ICCR1_CLO_SET == ((*piccr1_reg) & RIIC_ICCR1_CLO_SET))
            {
                ...
                else
                {
                    ...
                    *piccr1_reg = (uint32_t) (((*piccr1_reg) | RIIC_ICCR1_SCLO_SET) & RIIC_ICCR1_SOWP_CLR);
...
{
    volatile uint32_t * const picsr2_reg = RIIC_ICSR2_ADR(p_riic_info->ch_no);
    volatile uint32_t * const picier_reg = RIIC_ICIER_ADR(p_riic_info->ch_no);
    riic_return_t ret;
        ...
        case RIIC_MODE_M_SEND_RECEIVE :
            ...
            switch (riic_api_info[p_riic_info->ch_no].B_status)
            {
                ...
                case RIIC_STS_IDLE_EN_SLV :
                    ...
                    {
                        /* Sets a write code. */
                        buf_send_data = (uint32_t) ((*(p_riic_info->p_slv_adr)) << 1U);
...
static riic_return_t riic_after_dtct_stop_cond (riic_info_t * p_riic_info)
{
    ...
    volatile uint32_t * const picser_reg = RIIC_ICSER_ADR(p_riic_info->ch_no);
...
static void riic_init_io_register (riic_info_t * p_riic_info)
{
    ...
    /* Creates the register pointer for the specified RIIC channel. */
    volatile uint32_t * const piccr1_reg = RIIC_ICCR1_ADR(p_riic_info->ch_no);
    volatile uint32_t * const psar0_reg = RIIC_SAR0_ADR(p_riic_info->ch_no);
//    volatile uint8_t * const psaru0_reg = RIIC_SARU0_ADR(p_riic_info->ch_no);
    volatile uint32_t * const psar1_reg = RIIC_SAR1_ADR(p_riic_info->ch_no);
//    volatile uint8_t * const psaru1_reg = RIIC_SARU1_ADR(p_riic_info->ch_no);
    volatile uint32_t * const psar2_reg = RIIC_SAR2_ADR(p_riic_info->ch_no);
//    volatile uint8_t * const psaru2_reg = RIIC_SARU2_ADR(p_riic_info->ch_no);
    volatile uint32_t * const picser_reg = RIIC_ICSER_ADR(p_riic_info->ch_no);
    volatile uint32_t * const picmr2_reg = RIIC_ICMR2_ADR(p_riic_info->ch_no);
    volatile uint32_t * const picmr3_reg = RIIC_ICMR3_ADR(p_riic_info->ch_no);
    volatile uint32_t * const picfer_reg = RIIC_ICFER_ADR(p_riic_info->ch_no);
...
//    volatile uint8_t * const psaru2_reg = RIIC_SARU2_ADR(p_riic_info->ch_no);
    ...
    if (1U == g_riic_slv_ad0_format[p_riic_info->ch_no])
    {
        ...
        *psar0_reg = g_riic_slv_ad0_val[p_riic_info->ch_no] << 1;
...
//        *psaru0_reg = 0x00;
    ...
    else if (2U == g_riic_slv_ad0_format[p_riic_info->ch_no])
    {
        ...
        *psar0_reg = (uint32_t) (g_riic_slv_ad0_val[p_riic_info->ch_no] & RIIC_SAR_MASK);
...
//        RIIC_SAR_10BIT_FORMAT_SET);
    ...
    {
        /* 7bit address format setting */
        *psar1_reg = (uint32_t) (g_riic_slv_ad1_val[p_riic_info->ch_no] << 1);
...
//        *psaru1_reg = 0x00;
    ...
    {
        /* 10bit address format setting */
        *psar1_reg = (uint32_t) (g_riic_slv_ad1_val[p_riic_info->ch_no] & RIIC_SAR_MASK);
...
//        RIIC_SARU_10BIT_FORMAT_SET);
    ...
    {
        /* 7bit address format setting */
        *psar2_reg = (uint32_t) (g_riic_slv_ad2_val[p_riic_info->ch_no] << 1);
...
//        *psaru2_reg = 0x00;
    ...
    {
        /* 10bit address format setting */
        *psar2_reg = (uint32_t) (g_riic_slv_ad2_val[p_riic_info->ch_no] & RIIC_SAR_MASK);
 ...
 * Return Value : None
 **********************************************************************************************************************/
static void riic_int_icier_setting (riic_info_t * p_riic_info, uint32_t New_icier)
{
 ...
 * Return Value : None
 **********************************************************************************************************************/
static void riic_set_sending_data (riic_info_t * p_riic_info, uint32_t *p_data)
{
    volatile uint32_t uctmp = 0x00;

    /* Creates the register pointer for the specified RIIC channel. */
    volatile uint32_t * const picdrt_reg = RIIC_ICDRT_ADR(p_riic_info->ch_no);
 ...
 **********************************************************************************************************************/
static uint32_t riic_get_receiving_data (riic_info_t * p_riic_info)
{
    /* Creates the register pointer for the specified RIIC channel. */
    volatile uint32_t * const picdrr_reg = RIIC_ICDRR_ADR(p_riic_info->ch_no);
...
{
    volatile uint32_t uctmp;
    volatile uint32_t * const picmr1_reg = RIIC_ICMR1_ADR(p_riic_info->ch_no);
    volatile uint32_t * const picbrl_reg = RIIC_ICBRL_ADR(p_riic_info->ch_no);
    volatile uint32_t * const picbrh_reg = RIIC_ICBRH_ADR(p_riic_info->ch_no);
...
/*      }*/
    ...
    uctmp = (uint32_t) ((uint32_t) (*picmr1_reg) & (((~BIT4) & (~BIT5)) & (~BIT6)));

    *picmr1_reg = (uint32_t) ((uctmp) | ((cnt - 1) << 4)); /* Set ICMR1.CKS bits.*/
    *picbrl_reg = (uint32_t) ((((uint32_t) (calc_val - 1) | BIT7) | BIT6) | BIT5); /* Set value to ICBRL register */

    /*************** Calculation ICBRH value ***********************/
    calc_val = H_time; /* Set H width */
    calc_val = (calc_val / (d_cks[cnt - 1] / pclk_val)); /* Calculattion ICBRH value */
    calc_val = (uint32_t) (calc_val + 0.5); /* round off */
    ...
    *picbrh_reg = (uint32_t) ((((uint32_t) (calc_val - 1) | BIT7) | BIT6) | BIT5); /* Set value to ICBRH register */
...
void riic0_eei_sub (void)
{
    ...
    /* Checks Time Out. */
    if ((0U != (RIIC0.SR2.UINT32 & RIIC_ICSR2_TMOF_SET)) &&
    		(0U != (RIIC0.IER.UINT32 & RIIC_IER_TMOIE_SET)))
    {
        /* all interrupt disable */
        RIIC0.IER.UINT32 &= ~RIIC_IER_TMOIE_SET;
        while (0U != (RIIC0.IER.UINT32 & RIIC_IER_TMOIE_SET))
        {
            /* Do Nothing */
        }
    ...
    if ((0U != (RIIC0.SR2.UINT32 & RIIC_ICSR2_AL_SET)) &&
    		(0U != (RIIC0.IER.UINT32 & RIIC_IER_ALIE_SET)))
    {
        RIIC0.IER.UINT32 &= ~RIIC_IER_ALIE_SET;
        while (0U != (RIIC0.IER.UINT32 & RIIC_IER_ALIE_SET))
        {
            /* Do Nothing */
        }
    ...
    if ((0U != (RIIC0.SR2.UINT32 & RIIC_ICSR2_STOP_SET)) &&
    		(0U != (RIIC0.IER.UINT32 & RIIC_IER_SPIE_SET)))
    {
        ...
        RIIC0.IER.UINT32 &= ~RIIC_IER_SPIE_SET;

        RIIC0.MR3.UINT32 &= ~RIIC_ICMR3_RDRFS_SET; /* Refer to the technical update. */
        RIIC0.MR3.UINT32 &= ~RIIC_ICMR3_ACKWP_SET; /* Refer to the technical update. */
        RIIC0.MR3.UINT32 &= ~RIIC_ICMR3_ACKBT_SET; /* Refer to the technical update. */
        RIIC0.MR3.UINT32 &= ~RIIC_ICMR3_ACKWP_SET; /* Refer to the technical update. */
        while ((0U != (RIIC0.MR3.UINT32 & RIIC_ICMR3_RDRFS_SET)) ||
        		(0U != (RIIC0.MR3.UINT32 & RIIC_ICMR3_ACKBT_SET)))
        {
            /* Do Nothing */
        }

        /* Clears each status flag. */
        RIIC0.SR2.UINT32 &= ~RIIC_ICSR2_STOP_SET;
        while (0U != (RIIC0.SR2.UINT32 & RIIC_ICSR2_STOP_SET))
        {
            /* Do Nothing */
        }
    ...
    if ((0U != (RIIC0.SR2.UINT32 & RIIC_ICSR2_NACKF_SET)) &&
    		(0U != (RIIC0.IER.UINT32 & RIIC_IER_NAKIE_SET)))
    {
        /* Prohibits NACK interrupt to generate stop condition. */
        RIIC0.IER.UINT32 &= ~RIIC_IER_NAKIE_SET;

        /* Prohibits these interrupt. */
        /* After NACK interrupt, these interrupts will occur when they do not stop the following interrupts. */
        RIIC0.IER.UINT32 &= ~RIIC_IER_TEIE_SET;
        RIIC0.IER.UINT32 &= ~RIIC_IER_TIE_SET;
        RIIC0.IER.UINT32 &= ~RIIC_IER_RIE_SET;
        while (((0U != (RIIC0.IER.UINT32 & RIIC_IER_TEIE_SET)) ||
        		(0U != (RIIC0.IER.UINT32 & RIIC_IER_TIE_SET))) ||
        		(0U != (RIIC0.IER.UINT32 & RIIC_IER_RIE_SET)))
        {
            /* Do Nothing */
        }

        if (0U == (RIIC0.CR2.UINT32 & RIIC_ICCR2_TRS_SET))
        {
    ...
    if ((0U != (RIIC0.SR2.UINT32 & RIIC_ICSR2_START_SET))
    		&& (0U != (RIIC0.IER.UINT32 & RIIC_IER_STIE_SET)))
    {
        /* Disable start condition detection interrupt. */
        /* Clears status flag. */
        RIIC0.IER.UINT32 &= ~RIIC_IER_STIE_SET;
        RIIC0.SR2.UINT32 &= ~RIIC_ICSR2_START_SET;
        while ((0U != (RIIC0.SR2.UINT32 & RIIC_ICSR2_START_SET)) ||
        		(0U != (RIIC0.IER.UINT32 & RIIC_IER_STIE_SET)))
        {
            /* Do Nothing */
        }
...
void riic0_tei_sub (void)
{
    ...
    /* Clears ICSR2.TEND. */
    RIIC0.SR2.UINT32 &= ~RIIC_ICSR2_TEND_SET;
    while (0U != (RIIC0.SR2.UINT32 & RIIC_ICSR2_TEND_SET))
    {
        /* Do Nothing */
    }
...
uint32_t* RIIC_ICCR1_ADR(uint8_t n)
{
	return (n==0)?(&(RIIC0.CR1)):(&(RIIC1.CR1));
}
uint32_t* RIIC_ICCR2_ADR(uint8_t n)
{
	return (n==0)?(&(RIIC0.CR2)):(&(RIIC1.CR2));
}
uint32_t* RIIC_ICMR1_ADR(uint8_t n)
{
	return (n==0)?(&(RIIC0.MR1)):(&(RIIC1.MR1));
}
uint32_t* RIIC_ICMR2_ADR(uint8_t n)
{
	return (n==0)?(&(RIIC0.MR2)):(&(RIIC1.MR2));
}
uint32_t* RIIC_ICMR3_ADR(uint8_t n)
{
	return (n==0)?(&(RIIC0.MR3)):(&(RIIC1.MR3));
}
uint32_t* RIIC_ICFER_ADR(uint8_t n)
{
	return (n==0)?(&(RIIC0.FER)):(&(RIIC1.FER));
}
uint32_t* RIIC_ICSER_ADR(uint8_t n)
{
	return (n==0)?(&(RIIC0.SER)):(&(RIIC1.SER));
}
uint32_t* RIIC_ICIER_ADR(uint8_t n)
{
	return (n==0)?(&(RIIC0.IER)):(&(RIIC1.IER));
}
uint32_t* RIIC_ICSR1_ADR(uint8_t n)
{
	return (n==0)?(&(RIIC0.SR1)):(&(RIIC1.SR1));
}
uint32_t* RIIC_ICSR2_ADR(uint8_t n)
{
	return (n==0)?(&(RIIC0.SR2)):(&(RIIC1.SR2));
}
uint32_t* RIIC_SAR0_ADR(uint8_t n)
{
	return (n==0)?(&(RIIC0.SAR0)):(&(RIIC1.SAR0));
}
uint32_t* RIIC_SAR1_ADR(uint8_t n)
{
	return (n==0)?(&(RIIC0.SAR1)):(&(RIIC1.SAR1));
}
uint32_t* RIIC_SAR2_ADR(uint8_t n)
{
	return (n==0)?(&(RIIC0.SAR2)):(&(RIIC1.SAR2));
}
uint32_t* RIIC_ICBRL_ADR(uint8_t n)
{
	return (n==0)?(&(RIIC0.BRL)):(&(RIIC1.BRL));
}
uint32_t* RIIC_ICBRH_ADR(uint8_t n)
{
	return (n==0)?(&(RIIC0.BRH)):(&(RIIC1.BRH));
}
uint32_t* RIIC_ICDRT_ADR(uint8_t n)
{
	return (n==0)?(&(RIIC0.DRT)):(&(RIIC1.DRT));
}
uint32_t* RIIC_ICDRR_ADR(uint8_t n)
{
	return (n==0)?(&(RIIC0.DRR)):(&(RIIC1.DRR));
}
