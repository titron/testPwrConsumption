 ...
 *         : 30.09.2013 1.10     Change symbol of return value and status*         : 08.10.2013 1.20     Modified processing for the I/O register initialization and mode transition
...
/* 0 = single master mode, 1 = multi master mode(Master arbitration-lost detection is enabled.) */
    #define RIIC_CFG_CH0_MASTER_MODE        (0U)
    #define RIIC_CFG_CH1_MASTER_MODE        (1U)
    #define RIIC_CFG_CH2_MASTER_MODE        (1U)

/* Set slave address */
/* 0 = not, 1 = 7bit address format, 2 = 10bit address format */
    #define RIIC_CFG_CH0_SLV_ADDR0_FORMAT   (0x1U)
    #define RIIC_CFG_CH0_SLV_ADDR1_FORMAT   (0x0U)
    #define RIIC_CFG_CH0_SLV_ADDR2_FORMAT   (0x0U)
...
/* 0 = not use, 1 = use(General call address detection is enabled.) */
    #define RIIC_CFG_CH0_SLV_GCA_ENABLE     (0x0U)
    #define RIIC_CFG_CH1_SLV_GCA_ENABLE     (0x0U)
    #define RIIC_CFG_CH2_SLV_GCA_ENABLE     (0x0U)

/* This #define sets the priority level for the riic interrupt */
/* 1 lowest, 15 highest */
    #define RIIC_CFG_DISABLE_INT   			(0xCFU)
...
/* EEI and TEI interrupts are grouped as the BL1 interrupt in the RX64M and RX71M group. */
    #define RIIC_CFG_CH0_RXI_INT_PRIORITY   (0x4aU)
    #define RIIC_CFG_CH0_TXI_INT_PRIORITY   (0x4aU)
/* The priority level of the EEI, please do not lower than the priority level of TXI and RXI */
    #define RIIC_CFG_CH0_EEI_INT_PRIORITY   (0x49U)
/* The priority level of the TEI, please do not lower than the priority level of TXI and RXI */
    #define RIIC_CFG_CH0_TEI_INT_PRIORITY   (0x4aU)

    #define RIIC_CFG_CH1_RXI_INT_PRIORITY   (0x4aU)
    #define RIIC_CFG_CH1_TXI_INT_PRIORITY   (0x4aU)
/* The priority level of the EEI, please do not lower than the priority level of TXI and RXI */
    #define RIIC_CFG_CH1_EEI_INT_PRIORITY   (0x4aU)
/* The priority level of the TEI, please do not lower than the priority level of TXI and RXI */
    #define RIIC_CFG_CH1_TEI_INT_PRIORITY   (0x4aU)

    #define RIIC_CFG_CH2_RXI_INT_PRIORITY   (0x4aU)
    #define RIIC_CFG_CH2_TXI_INT_PRIORITY   (0x4aU)
/* The priority level of the EEI, please do not lower than the priority level of TXI and RXI */
    #define RIIC_CFG_CH2_EEI_INT_PRIORITY   (0x4aU)
/* The priority level of the TEI, please do not lower than the priority level of TXI and RXI */
    #define RIIC_CFG_CH2_TEI_INT_PRIORITY   (0x4aU)

/* Select Timeout function enable or disable */
/* 0 = disable, 1 = enable */
    #define RIIC_CFG_CH0_TMO_ENABLE         (0U)
