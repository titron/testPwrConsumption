...
/* Select the ports (SCL0 and SDA0) to use in RIIC0 */
    #define R_RIIC_CFG_RIIC0_SCL0_PORT   PORT_0     /* Port Number */
    #define R_RIIC_CFG_RIIC0_SCL0_BIT    BIT_12     /* Bit Number  */
	#define R_RIIC_PORT_FUNC_SCL0		 PORT_FUNCTION_ALTLV0

    #define R_RIIC_CFG_RIIC0_SDA0_PORT   PORT_0     /* Port Number */
    #define R_RIIC_CFG_RIIC0_SDA0_BIT    BIT_11     /* Bit Number  */
	#define R_RIIC_PORT_FUNC_SDA0		 PORT_FUNCTION_ALTLV0
